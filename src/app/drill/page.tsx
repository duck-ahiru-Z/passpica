...
const CONTENTS: LearningContent[] = [
  ...
  {
    title: '対数の底の変換公式と性質',
    description: '底の変換公式や逆数の性質などを利用して対数計算を素早く行う演習。',
    link: '/learn/math/logarithm-drill',
    subject: 'math',
    subjectJp: '数学Ⅱ',
    field: '指数関数・対数関数',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'logarithm-drill',
  },
  {
    title: '等差・等比数列の和',
    description: '数列の和の公式を正確に適用し、符号や分数の処理をミスなく行う反復演習。',
    link: '/learn/math/sequence-sum-drill',
    subject: 'math',
    subjectJp: '数学B',
    field: '数列',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'sequence-sum-drill',
  },
  {
    title: 'Σ（シグマ）の計算',
    description: 'Σ記号の扱いに慣れ、公式の展開から具体的な数値の計算までをスムーズに行う演習。',
    link: '/learn/math/sigma-calculation-drill',
    subject: 'math',
    subjectJp: '数学B',
    field: '数列',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'sigma-calculation-drill',
  },
  {
    title: 'ベクトルの内積・なす角',
    description: '成分表示されたベクトルの内積計算、なす角、垂直条件、大きさの平方などの基本操作演習。',
    link: '/learn/math/vector-dot-product-drill',
    subject: 'math',
    subjectJp: '数学C',
    field: 'ベクトル',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'vector-dot-product-drill',
  },
  {
    title: '複素数の極形式変換',
    description: '複素数平面上での位置の把握、極形式への変換、積・商の計算を直感的にマスターする演習。',
    link: '/learn/math/complex-polar-drill',
    subject: 'math',
    subjectJp: '数学C',
    field: '複素数平面',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'complex-polar-drill',
  },
  {
    title: '2次曲線の焦点と方程式（楕円）',
    description: '楕円の標準形・一般形から焦点や中心を正確に求める演習。',
    link: '/learn/math/ellipse-drill',
    subject: 'math',
    subjectJp: '数学C',
    field: '2次曲線',
    difficulty: '標準',
  ...
  {
    title: '2次曲線の焦点と方程式（双曲線・放物線）',
    description: '双曲線の漸近線と焦点、放物線の準線と焦点など、それぞれの曲線の特徴的な要素を計算する演習。',
    link: '/learn/math/hyperbola-parabola-drill',
    subject: 'math',
    subjectJp: '数学C',
    field: '2次曲線',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'hyperbola-parabola-drill',
  },
  {
    title: 'データの分析（1変量）',
    description: '平均・分散などの代表値の計算、分散の別公式の活用、変量の変換則を練習する演習。',
    link: '/learn/math/data-analysis-1d-drill',
    subject: 'math',
    subjectJp: '数学Ⅰ',
    field: 'データの分析',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'data-analysis-1d-drill',
  },
  {
    title: 'データの分析（2変量）',
    description: '共分散と相関係数の計算、散布図からの相関係数の推定、クロス集計表の読み取り演習。',
    link: '/learn/math/data-analysis-2d-drill',
    subject: 'math',
    subjectJp: '数学Ⅰ',
    field: 'データの分析',
    difficulty: '標準',
    type: '無限計算ドリル',
    slug: 'data-analysis-2d-drill',
  }
];
